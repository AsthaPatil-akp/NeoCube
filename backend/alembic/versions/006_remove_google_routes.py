"""Remove unused Google Routes cache and match transit columns

Revision ID: 006_remove_google_routes
Revises: 005_delivery_feasibility
...
revision = "006_remove_google_routes"
down_revision = "005_delivery_feasibility"
branch_labels = None
depends_on = None
